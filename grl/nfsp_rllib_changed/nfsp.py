...
from grl.nfsp_rllib.reservoir_replay_buffer import ReservoirReplayActor, LocalReservoirReplayBuffer
from grl.nfsp_rllib.nfsp_torch_avg_policy import NFSPTorchAveragePolicy
logger = logging.getLogger(__name__)

def debug_before_learn_on_batch(x, *args, **kwargs):
    print("NFSP trainer learn on batch")
    return x
