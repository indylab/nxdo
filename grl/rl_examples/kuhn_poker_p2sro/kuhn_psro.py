...
from grl.rl_examples.kuhn_poker_p2sro.config import kuhn_sac_params, kuhn_dqn_params
...
def train_poker_best_response(player, print_train_results=True):
    ...
    trainer_config = merge_dicts(trainer_config, kuhn_dqn_params(action_space=tmp_env.action_space))
