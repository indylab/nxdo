...
class ReservoirBuffer(object):
    ...
    def __init__(self, reservoir_buffer_capacity=5000):
...
def train_poker_off_policy_rl_nfsp(results_dir: str,
    ...
    br_trainer_configs = [merge_dicts({
        ...
        "multiagent": {
            ...
            "policies": {
                "best_response": (br_policy_class, tmp_env.observation_space, tmp_env.action_space, {}),
                "opponent_average_policy": (br_policy_class, tmp_env.observation_space, tmp_env.action_space, {}),
                "opponent_best_response": (br_policy_class, tmp_env.observation_space, tmp_env.action_space, {}),
            },
            "policy_mapping_fn": get_select_policy(trainer_player_num=player),
        },
    }, hyperparams(tmp_env.action_space)) for player in range(2)]
